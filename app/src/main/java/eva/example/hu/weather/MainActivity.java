...
//          String sunriseDateformat = new SimpleDateFormat("HH:mm").format(new Date(currentWeather.getDaily().getData().get(0).getSunriseTime() + ""));
//          String sunsetDateformat = new SimpleDateFormat("HH:mm").format(new Date(currentWeather.getDaily().getData().get(0).getSunriseTime() + "));

//          String sunriseDf = df.format(new Date(currentWeather.getDaily().getData().get(0).getSunriseTime() + ""));
//          String sunsetDf = df.format(new Date(currentWeather.getDaily().getData().get(0).getSunsetTime() + ""));
...
//          sunset.setText("Sunset: " + sunsetDateformat + "");
          ...
          //updated.setText("updated: " + currentWeather.getCurrently().getTime());
